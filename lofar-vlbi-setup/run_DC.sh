...
singularity exec -B $PWD,/project,/home/lofarvwf-jdejong/scripts $SIMG python /home/lofarvwf-jdejong/scripts/lofar_vlbi_helpers/extra_scripts/change_hash_name.py --path ${RUNDIR}/Delay-Calibration --suffix msdpppconcat
