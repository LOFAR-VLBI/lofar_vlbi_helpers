...
cd target
singularity exec -B ${SING_BIND} ${SIMG} /project/lofarvwf/Software/flocs/runners/run_LINC_target.sh -d $STARTDIR/target/Data -c $STARTDIR/calibrator/linc_calibrator_output/results_LINC_calibrator/cal_solutions.h5
cd ../
