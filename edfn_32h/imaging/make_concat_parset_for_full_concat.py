...
for observation in all_obs:
    try:
        ...
        os.system(f'python /home/lofarvwf-jdejong/scripts/lofar_vlbi_helpers/extra_scripts/make_freq_list_with_dummies.py --ms {mschain} --make_dummies --output_name {txt_name}')
