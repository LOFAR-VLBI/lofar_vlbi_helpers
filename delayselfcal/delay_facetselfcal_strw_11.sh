...
#INCREASED scalarphase smoothness and INCREASED fulljones solint and DECREASED smoothness fulljones --> rijn5/data2/jurjendejong
...
--smoothnessconstraint-list="[10.0,2,7.5,15.0,2.5]" \
