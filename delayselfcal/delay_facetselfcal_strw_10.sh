...
#INCREASED scalarphase smoothness and INCREASED fulljones solint and INCREASED smoothness fulljones --> rijn5/data2/jurjendejong
...
--solint-list="['8min','32s','20min','40min','100min']" \
--nchan-list="[1,1,1,1,1]" \
--smoothnessconstraint-list="[10.0,2,7.5,15.0,7.5]" \
