...
#INCREASED scalarphase smoothness and reduced fulljones --> rijn5/data2/jurjendejong
...
--solint-list="['8min','32s','20min','40min','60min']" \
--nchan-list="[1,1,1,1,1]" \
--smoothnessconstraint-list="[10.0,2.0,7.5,15.0,5.0]" \
