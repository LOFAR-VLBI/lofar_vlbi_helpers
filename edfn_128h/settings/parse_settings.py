...
surf_bind = "/project,/project/wfedfn/Software,/project/wfedfn/Share,/project/wfedfn/Public,"+home
surf_simg_amd = "/project/wfedfn/Software/singularity/flocs_v5.3.0_znver2_znver2.sif"
surf_simg_intel = "/project/wfedfn/Software/singularity/flocs_v5.3.0_sandybridge_sandybridge.sif"
surf_h5_merger = '/project/wfedfn/Software/lofar_helpers/h5_merger.py'
surf_lofar_helpers = '/project/wfedfn/Software/lofar_helpers'
surf_facet_selfcal = '/project/wfedfn/Software/lofar_facet_selfcal/facetselfcal.py'
surf_lofar_facet_selfcal = '/project/wfedfn/Software/lofar_facet_selfcal'
