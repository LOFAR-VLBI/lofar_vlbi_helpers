...
echo "Applycal"
singularity exec -B $PWD,/project/wfedfn/ ${SIMG} python \
...
singularity exec -B $SING_BIND ${SIMG##*/} python /home/wfedfn-jpetley/scripts/lofar_vlbi_helpers/elais_128h/ddf/fix_symlink.py

echo "SUBTRACT"
singularity exec -B $PWD,/project/wfedfn/ ${SIMG##*/} sub-sources-outside-region.py \
--boxfile boxfile.reg \
